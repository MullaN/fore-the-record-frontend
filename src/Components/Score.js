...
const Score = (props) => {
    return(
        <tr>
            <td><div className='AvatarLink'><a href={`/users/${props.round.user.id}`}><img src={props.round.user.avatar} alt={props.round.user.username} title={props.round.user.username}/></a></div></td>
